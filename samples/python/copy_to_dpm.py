...
argParser.add_argument('--targetDir',   action='store',         nargs='?',  type=str, default = 'Stops2l-postprocessed', help="Name of the directory the post-processed files will be saved" )
...
targetDir = '/dpm/oeaw.ac.at/home/cms/store/user/%s/%s/%s'%( os.environ['USER'], args.targetDir, data_postProcessing_directory) 

jobs=[]

for path in [ mc_source_path, data_source_path]:
    for obj in os.listdir(path):
        jobs.append( ( os.path.join( path, obj ), os.path.join(targetDir)) )
