...
#dirs['singleT']          = ["TToLeptons_sch", "TToLeptons_tch_amcatnlo_comb", "T_tWch"] # ["TBar_tWch_DS", "T_tWch_DS"]
...
dirs['QCD_EM+bcToE']     = ["QCD_Pt_20to30_bcToE", "QCD_Pt_30to80_bcToE", "QCD_Pt_80to170_bcToE",  "QCD_Pt_250toInf_bcToE", "QCD_Pt15to20_EMEnriched", "QCD_Pt20to30_EMEnriched", "QCD_Pt50to80_EMEnriched", "QCD_Pt80to120_EMEnriched", "QCD_Pt120to170_EMEnriched", "QCD_Pt170to300_EMEnriched"]
...
for key in dirs:
  dirs[key] = [ os.path.join( data_directory, 'postProcessed_Fall15_mAODv2/singlelepTiny', dir) for dir in dirs[key]]
...
WZZ            = Sample.fromDirectory(name="WZZ",              treeName="Events", isData=False, color=ROOT.kYellow,   texName="WZZ",                       directory=dirs['WZZ'])
