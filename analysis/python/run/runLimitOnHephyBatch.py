...
for i, estimator in enumerate(signalEstimators):
        ...
        #if estimator == "T2tt_350_100" or estimator == "T2tt_350_150": continue
        #   os.system(cmd+" 'python run_limit.py --signal T2tt --unblind --fitAll  --year 2016 --skipFitDiagnostics --only=%s'"%str(i))
    # next up p95 2016!
    os.system(cmd+" 'python run_limit.py --signal T8bbllnunu_XCha0p5_XSlep0p95 --unblind --fitAll  --year 2018 --skipFitDiagnostics --only=%s'"%str(i))
