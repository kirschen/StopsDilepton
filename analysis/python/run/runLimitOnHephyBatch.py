...
#cmd = "submitBatch.py --title='T2bW17'"
cmd = "echo"
...
for i, estimator in enumerate(signalEstimators):
    ...
    # fitAll
    #os.system(cmd+" 'python run_limit.py --signal T2tt --expected --fitAll  --year 2017 --skipFitDiagnostics --only=%s'"%str(i))
    #os.system(cmd+" 'python run_limit.py --signal T2bW --expected --fitAll  --year 2017 --skipFitDiagnostics --only=%s'"%str(i))
    #os.system(cmd+" 'python run_limit.py --signal T8bbllnunu_XCha0p5_XSlep0p05 --expected --fitAll  --year 2017 --skipFitDiagnostics --only=%s'"%str(i))
    #os.system(cmd+" 'python run_limit.py --signal T8bbllnunu_XCha0p5_XSlep0p5 --expected --fitAll  --year 2017 --skipFitDiagnostics --only=%s'"%str(i))
