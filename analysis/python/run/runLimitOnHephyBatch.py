...
#from StopsDilepton.samples.nanoTuples_FastSim_Summer16_postProcessed import signals_T8bbllnunu_XCha0p5_XSlep0p09 
...
#from StopsDilepton.samples.nanoTuples_FastSim_Fall17_postProcessed import signals_T8bbllnunu_XCha0p5_XSlep0p09 
...
#from StopsDilepton.samples.nanoTuples_FastSim_Autumn18_postProcessed import signals_T8bbllnunu_XCha0p5_XSlep0p09
...
#cmd = "submitBatch.py --title='Limit2018'"
cmd = "echo"
...
for i, estimator in enumerate(signalEstimators):
   ...
   # os.system(cmd+" 'python run_limit.py --signal T8bbllnunu_XCha0p5_XSlep0p05 --expected --fitAll  --year 2018 --skipFitDiagnostics --only=%s'"%str(i))
   # os.system(cmd+" 'python run_limit.py --signal T8bbllnunu_XCha0p5_XSlep0p09 --expected --fitAll  --year 2018 --skipFitDiagnostics --only=%s'"%str(i))
