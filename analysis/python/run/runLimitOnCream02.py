...
for i, estimator in enumerate(signalEstimators):
  ...
  os.system("qsub -v command=\"./run_limit.py --regions=O               --only=" + str(i) + "\" -q localgrid@cream02 -o " + logfile + " -e " + logfileErr + " -l walltime=8:00:00 runEstimatesOnCream02.sh")
  os.system("qsub -v command=\"./run_limit.py --regions=O --controlDYVV --only=" + str(i) + "\" -q localgrid@cream02 -o " + logfile + " -e " + logfileErr + " -l walltime=8:00:00 runEstimatesOnCream02.sh")
  time.sleep(10)
