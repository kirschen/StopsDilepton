...
class Setup:
    def __init__(self):
        ...
        self.sys      = {'weight':'weight', 'reweight':['reweightPU36fb','reweightDilepTriggerBackup','reweightBTag_SF','reweightLeptonSF','reweightLeptonHIPSF'], 'selectionModifier':None}#reweightTopPt
        self.lumi     = lumi
            ...
            for k in sys.keys():
                if k=='reweight':
                    ...
                    for upOrDown in ['Up','Down']:
                      ...
                      #if 'reweightTopPt'+upOrDown              in res.sys[k]: res.sys[k].remove('reweightTopPt')
