...
regionsLegacy   = [Region("dl_mt2ll", (0, 100)) + Region("dl_mt2blbl", (0, -1)) + Region("MET_significance", (12, -1))] + getRegionsMetSig( mt2llThresholds = [ 100, 140, 240 ], mt2blblThresholds = [ 0, 100, 200, -1], metsigThresholds = [ 12,-1] ) + getRegionsMetSig( mt2llThresholds = [ 240, -1 ], mt2blblThresholds = [ 0, -1], metsigThresholds = [ 12, -1] )
