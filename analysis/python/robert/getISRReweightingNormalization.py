...
from StopsDilepton.samples.heppy_dpm_samples import T2tt_heppy_mapper, T8bbllnunu_heppy_mapper, ttbarDM_heppy_mapper

isrWeight = ISRweight().getWeightString()

if args.signal == 'T2tt' or args.small or 'T8bbllnunu' in args.signal:
