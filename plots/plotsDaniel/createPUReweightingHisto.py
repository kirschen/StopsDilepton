...
mc   = Sample.combine("mc", [ Top_pow, diBoson, DY_HT_LO, TTZ_LO, TTW, triBoson, TWZ ] )
...
nTrueInt_data_XSecVVUp    = getObjFromFile("$CMSSW_BASE/src/StopsDilepton/tools/data/puReweightingData/PU_2016_36000_XSecVVUp.root", "pileup")
nTrueInt_data_XSecVUp     = getObjFromFile("$CMSSW_BASE/src/StopsDilepton/tools/data/puReweightingData/PU_2016_36000_XSecVUp.root", "pileup")
nTrueInt_data_XSecUp      = getObjFromFile("$CMSSW_BASE/src/StopsDilepton/tools/data/puReweightingData/PU_2016_36000_XSecUp.root", "pileup")
nTrueInt_data_XSecVDown   = getObjFromFile("$CMSSW_BASE/src/StopsDilepton/tools/data/puReweightingData/PU_2016_36000_XSecVDown.root", "pileup")
nTrueInt_data_XSecDown    = getObjFromFile("$CMSSW_BASE/src/StopsDilepton/tools/data/puReweightingData/PU_2016_36000_XSecDown.root", "pileup")
nTrueInt_data_XSecCentral = getObjFromFile("$CMSSW_BASE/src/StopsDilepton/tools/data/puReweightingData/PU_2016_36000_XSecCentral.root", "pileup")
...
nTrueInt_data_XSecVVUp.Scale(nTrueInt_data_XSecCentral.Integral()/nTrueInt_data_XSecVVUp.Integral())
...
plotting.draw(
    ...
    plot_directory = '/afs/hephy.at/user/d/dspitzbart/www/pngPU/', #ratio = ratio, 
...
pickle.dump({'rw':reweightingHisto, 'up':reweightingHisto_Up, 'down':reweightingHisto_Down, 'vup':reweightingHisto_VUp, 'vdown':reweightingHisto_VDown}, file("/afs/hephy.at/data/dspitzbart01/StopsDilepton/puReweightingData2016/"+prefix+".pkl", "w") )
