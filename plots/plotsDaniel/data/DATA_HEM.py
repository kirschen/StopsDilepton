...
def drawPlots(plots, mode, lumi_scale):
  for log in [False, True]:
    ...
    for plot in plots:
      ...
      ratio_histos = [(1,0), (2,0)]
      
      plotting.draw(plot,
        plot_directory = plot_directory_,
        ratio = {'yRange':(0.1,1.9), 'texY': 'HEM/nominal', 'histos':ratio_histos},
...
for index, mode in enumerate(allModes):
    ...
    if mode == 'mumu':
        data_2018_sample = DoubleMuon
        data_2018_sample_HEM = DoubleMuon_HEM
        data_2018_sample_HEMmitigation = DoubleMuon_HEMmitigation
    elif mode == 'mue':
        data_2018_sample = MuonEG
        data_2018_sample_HEM = MuonEG_HEM
        data_2018_sample_HEMmitigation = MuonEG_HEMmitigation
    elif mode == 'ee':
        data_2018_sample = EGamma
        data_2018_sample_HEM = EGamma_HEM
        data_2018_sample_HEMmitigation = EGamma_HEMmitigation
    ...
    data_2018_sample_HEMmitigation.style  = styles.errorStyle(ROOT.kGreen+1, markerStyle=20)
    ...
    data_2018_sample_HEMmitigation.addSelectionString([getFilterCut(isData=True, year=2018, ignoreJSON=False), getLeptonSelection(mode)])
    #data_2018_sample_HEM.addSelectionString([getFilterCut(isData=True, year=2018, ignoreJSON=False), getLeptonSelection(mode)])
    ...
    stack_samples.append( [data_2018_sample_HEMmitigation] )
    ...
    plots2D.append(Plot2D.fromHisto(
        name = 'jetOccupancy_HEMmitigation',
