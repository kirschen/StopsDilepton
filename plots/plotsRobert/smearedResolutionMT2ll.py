...
#
        ...
        dl_mt2ll_ele_smeared  = Plot(
            ...
            texX = 'MT_{2}^{ll} (GeV)', texY = 'Number of Events / 15 GeV',
            stack = stack, 
            attribute = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:abs(event.dl_mt2ll_ele_smeared)),
            binning=[300/15,0,300],
            selectionString = selectionString,
            weight = weight,
            )
        ...
        dl_mt2ll_met_smeared  = Plot(
            ...
            texX = 'MT_{2}^{ll} (GeV)', texY = 'Number of Events / 15 GeV',
            stack = stack, 
            attribute = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:abs(event.dl_mt2ll_met_smeared)),
            binning=[300/15,0,300],
            selectionString = selectionString,
            weight = weight,
            )
...
#            stack = stack, 
#            variable = TreeVariable.fromString( "l1_miniRelIso/F" ),
#            binning=[40,0,2],
#            selectionString = selectionString,
#            weight = weight,
#            )
...
#            stack = stack, 
#            variable = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:abs(event.l1_dxy), uses = "l1_dxy/F"),
#            binning=[40,0,1],
#            selectionString = selectionString,
#            weight = weight,
#            )
...
#            stack = stack, 
#            variable = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:abs(event.l1_dz), uses = "l1_dz/F"),
#            binning=[40,0,0.15],
#            selectionString = selectionString,
#            weight = weight,
#            )
...
#            texX = 'I_{rel.mini}', texY = 'Number of Events / 5 GeV',
#            stack = stack, 
#            variable = TreeVariable.fromString( "l2_miniRelIso/F" ),
#            binning=[40,0,2],
#            selectionString = selectionString,
#            weight = weight,
#            )
...
#            texX = '|d_{xy}|', texY = 'Number of Events',
#            stack = stack, 
#            variable = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:abs(event.l2_dxy), uses = "l2_dxy/F"),
#            binning=[40,0,1],
#            selectionString = selectionString,
#            weight = weight,
#            )
...
#            texX = '|d_{z}|', texY = 'Number of Events',
#            stack = stack, 
#            variable = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:abs(event.l2_dz), uses = "l2_dz/F"),
#            binning=[40,0,0.15],
#            selectionString = selectionString,
#            weight = weight,
#            )
