...
#python analysisPlots.py --selection njet01-btag0-relIso0.12-looseLeptonVeto-mll20-met80-metSig5
#python analysisPlots.py --selection njet01-btag1p-relIso0.12-looseLeptonVeto-mll20-metInv
#python analysisPlots.py --selection njet01-btag1p-relIso0.12-looseLeptonVeto-mll20-met80-metSig5
#python analysisPlots.py --selection njet2p-relIso0.12-looseLeptonVeto-mll20
#python analysisPlots.py --selection njet2p-relIso0.12-looseLeptonVeto-mll20-onZ
#python analysisPlots.py --selection njet2p-relIso0.12-looseLeptonVeto-mll20-onZ-met80-metSig5-dPhiInv-mt2ll100
#python analysisPlots.py --selection njet2p-btag0-relIso0.12-looseLeptonVeto-mll20-metInv
#python analysisPlots.py --selection njet2p-btag0-relIso0.12-looseLeptonVeto-mll20-met80-metSig5
#python analysisPlots.py --selection njet2p-btag0-relIso0.12-looseLeptonVeto-mll20-onZ-met80-mt2ll100
#python analysisPlots.py --selection njet2p-btag0-relIso0.12-looseLeptonVeto-mll20-onZ-met80-metSig5-mt2ll100
#python analysisPlots.py --selection njet2p-btag0-relIso0.12-looseLeptonVeto-mll20-onZ-met80-metSig5-dPhiInv				# DY control
#python analysisPlots.py --selection njet2p-btag0-relIso0.12-looseLeptonVeto-mll20-onZ-met80-metSig5-dPhiInv-mt2ll100
#python analysisPlots.py --selection njet2p-btag0-relIso0.12-looseLeptonVeto-mll20-onZ-met80-metSig5-dPhiJet0-dPhiJet1		# VV control
#python analysisPlots.py --selection njet2p-btag0-relIso0.12-looseLeptonVeto-mll20-onZ-met80-metSig5-dPhiJet0-dPhiJet1-mt2ll100
#python analysisPlots.py --selection njet2p-btag1p-relIso0.12-looseLeptonVeto-mll20
#python analysisPlots.py --selection njet2p-btag1p-relIso0.12-looseLeptonVeto-mll20-metInv
#python analysisPlots.py --selection njet2p-btag1p-relIso0.12-looseLeptonVeto-mll20-met80
#python analysisPlots.py --selection njet2p-btag1p-relIso0.12-looseLeptonVeto-mll20-met80-metSig5
#python analysisPlots.py --selection njet2p-btag1p-relIso0.12-looseLeptonVeto-mll20-met80-metSig5-dPhiJet0
#python analysisPlots.py --selection njet2p-btag1p-relIso0.12-looseLeptonVeto-mll20-met80-metSig5-dPhiJet0-dPhiJet1
#python analysisPlots.py --selection njet2p-btag1p-relIso0.12-looseLeptonVeto-mll20-met80-metSig5-dPhiJet0-dPhiJet1-mt2ll100
#python analysisPlots.py --selection njet2p-btag1p-relIso0.12-looseLeptonVeto-mll20-met80-metSig5-dPhiJet0-dPhiJet1-mt2ll140
#python analysisPlots.py --selection njet2p-btag1p-relIso0.12-looseLeptonVeto-mll20-onZ-met80-metSig5-dPhiJet0-dPhiJet1
#python analysisPlots.py --selection njet2p-btag1p-relIso0.12-looseLeptonVeto-mll20-onZ-met80-metSig5-dPhiJet0-dPhiJet1-mt2ll100
