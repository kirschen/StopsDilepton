...
python recoil_v5.py --selection lepSel-njet1p-btag0-relIso0.12-looseLeptonVeto-mll20-onZ --mode SF --era Run2016
python recoil_v5.py --selection lepSel-njet1p-btag0-relIso0.12-looseLeptonVeto-mll20-onZ --mode SF --era Run2016BCD
python recoil_v5.py --selection lepSel-njet1p-btag0-relIso0.12-looseLeptonVeto-mll20-onZ --mode SF --era Run2016EF
python recoil_v5.py --selection lepSel-njet1p-btag0-relIso0.12-looseLeptonVeto-mll20-onZ --mode SF --era Run2016GH

python recoil_v5.py --selection lepSel-njet1p-btag0-relIso0.12-looseLeptonVeto-mll20-onZ --mode SF --era Run2017
python recoil_v5.py --selection lepSel-njet1p-btag0-relIso0.12-looseLeptonVeto-mll20-onZ --mode SF --era Run2017B
python recoil_v5.py --selection lepSel-njet1p-btag0-relIso0.12-looseLeptonVeto-mll20-onZ --mode SF --era Run2017CDE
python recoil_v5.py --selection lepSel-njet1p-btag0-relIso0.12-looseLeptonVeto-mll20-onZ --mode SF --era Run2017F

python recoil_v5.py --selection lepSel-njet1p-btag0-relIso0.12-looseLeptonVeto-mll20-onZ --mode SF --era Run2018
python recoil_v5.py --selection lepSel-njet1p-btag0-relIso0.12-looseLeptonVeto-mll20-onZ --mode SF --era Run2018A
python recoil_v5.py --selection lepSel-njet1p-btag0-relIso0.12-looseLeptonVeto-mll20-onZ --mode SF --era Run2018B
python recoil_v5.py --selection lepSel-njet1p-btag0-relIso0.12-looseLeptonVeto-mll20-onZ --mode SF --era Run2018C
python recoil_v5.py --selection lepSel-njet1p-btag0-relIso0.12-looseLeptonVeto-mll20-onZ --mode SF --era Run2018D
