...
tag_pt  = Plot(
    ...
    stack = stack, 
    attribute = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:event.tag_pt),
    binning=[60,0,300],
...
tag_eta  = Plot(
    ...
    stack = stack, 
    attribute = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:event.tag_eta),
    binning=[36,-3.3,3.3],
    selectionString = selectionString,
    weight = weight,
    )
...
tag_phi  = Plot(
    ...
    stack = stack, 
    attribute = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:event.tag_phi),
    binning=[30,-pi,pi],
    selectionString = selectionString,
    weight = weight,
    )
...
tag_miniRelIso  = Plot(
    ...
    stack = stack, 
    attribute = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:event.tag_miniRelIso),
    binning=[40,0,2],
    selectionString = selectionString,
    weight = weight,
    )
...
tag_jetPtRelv2  = Plot(
    ...
    stack = stack, 
    attribute = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:event.tag_jetPtRelv2),
    binning=[50,0,50],
    selectionString = selectionString,
    weight = weight,
    )
...
tag_jetPtRatiov2  = Plot(
    ...
    stack = stack, 
    attribute = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:event.tag_jetPtRatiov2),
    binning=[28,0,1.4],
    selectionString = selectionString,
    weight = weight,
    )
...
probe_pt  = Plot(
    ...
    stack = stack, 
    attribute = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:event.probe_pt),
    binning=[60,0,300],
    selectionString = selectionString,
    weight = weight,
    )
...
probe_eta  = Plot(
    ...
    stack = stack, 
    attribute = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:event.probe_eta),
    binning=[36,-3.3,3.3],
    selectionString = selectionString,
    weight = weight,
    )
...
probe_phi  = Plot(
    ...
    stack = stack, 
    attribute = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:event.probe_phi),
    binning=[30,-pi,pi],
    selectionString = selectionString,
    weight = weight,
    )
...
probe_miniRelIso  = Plot(
    ...
    stack = stack, 
    attribute = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:event.probe_miniRelIso),
    binning=[40,0,2],
    selectionString = selectionString,
    weight = weight,
    )
...
probe_jetPtRelv2  = Plot(
    ...
    stack = stack, 
    attribute = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:event.probe_jetPtRelv2),
    binning=[50,0,50],
    selectionString = selectionString,
    weight = weight,
    )
...
probe_jetPtRelv2_miniRelIsoVT  = Plot(
    ...
    texX = 'jetPtRelv2(probe)', texY = 'Number of Events',
    stack = stack, 
    attribute = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:event.probe_jetPtRelv2 if event.probe_miniRelIso<0.09 else float('nan')),
    binning=[50,0,50],
    selectionString = selectionString,
    weight = weight,
    )
...
probe_jetPtRatiov2  = Plot(
    ...
    stack = stack, 
    attribute = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:event.probe_jetPtRatiov2),
    binning=[28,0,1.4],
    selectionString = selectionString,
    weight = weight,
    )
...
probe_jetPtRatiov2_miniRelIsoVT  = Plot(
    ...
    texX = 'jetPtRatiov2(probe)', texY = 'Number of Events',
    stack = stack, 
    attribute = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:event.probe_jetPtRatiov2 if event.probe_miniRelIso<0.09 else float('nan')),
    binning=[28,0,1.4],
    selectionString = selectionString,
    weight = weight,
    )
...
probe_jetPtRatiov2_miniRelIsoVT_ptRel07  = Plot(
    ...
    texX = 'jetPtRatiov2(probe)', texY = 'Number of Events',
    stack = stack, 
    attribute = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:event.probe_jetPtRatiov2 if (event.probe_miniRelIso<0.09 and event.probe_jetPtRelv2<7.2) else float('nan')),
    binning=[28,0,1.4],
    selectionString = selectionString,
    weight = weight,
    )
...
tp_mass  = Plot(
    ...
    stack = stack, 
    attribute = ScalarTreeVariable.uniqueFloat().addFiller(lambda event:event.mll),
    binning=[150/3,0,150],
    selectionString = selectionString,
    weight = weight,
    )
