...
for index, mode in enumerate(allModes):
  ...
  plots.append(Plot(
    texX = 'M_{T2}(ll) (GeV)', texY = 'Number of Events / 30 GeV',
    attribute = TreeVariable.fromString( "dl_mt2ll/F" ),
    binning= [510/30,0,510],
  ))
  ...
  plots.append(Plot(
    texX = 'p_{T}(ll) (GeV)', texY = 'Number of Events / 30 GeV',
  ...
  plots.append(Plot(
    texX = 'p_{T}(l_{1}) (GeV)', texY = 'Number of Events / 25 GeV',
  ...
  plots.append(Plot(
    texX = 'p_{T}(l_{2}) (GeV)', texY = 'Number of Events / 25 GeV',
  ...
  if args.selection.count('njet2') or args.selection.count('njet1'):
    plots.append(Plot(
      texX = 'p_{T}(leading jet) (GeV)', texY = 'Number of Events / 40 GeV',
  ...
  if args.selection.count('njet2'):
    plots.append(Plot(
      texX = 'p_{T}(2nd leading jet) (GeV)', texY = 'Number of Events / 40 GeV',
    ...
    plots.append(Plot( name = "dl_mt2blbl_coarse",       # SR binning of MT2ll
      texX = 'M_{T2}(blbl) (GeV)', texY = 'Number of Events / 100 GeV',
      attribute = TreeVariable.fromString( "dl_mt2blbl/F" ),
      binning=[600/100, 0, 600],
    ))
