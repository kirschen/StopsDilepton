...
python nanoPostProcessing.py  --forceProxy --skim dilep --year 2018 --processingEra stops_2018_nano_v0p11  --skipGenLepMatching --noTopPtReweighting --flagTTBar --sample TTSemiLep_pow #SPLIT80
