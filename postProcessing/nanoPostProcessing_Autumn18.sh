...
## low mass #
#python nanoPostProcessing.py  --forceProxy --skim dilep --year 2018 --processingEra stops_2018_nano_v0p10  --skipGenLepMatching --LHEHTCut 70 --sample DYJetsToLL_M10to50_LO # SPLIT40
#python nanoPostProcessing.py  --forceProxy --skim dilep --year 2018 --processingEra stops_2018_nano_v0p10  --skipGenLepMatching --sample DYJetsToLL_M4to50_HT70to100 # SPLIT20
#python nanoPostProcessing.py  --forceProxy --skim dilep --year 2018 --processingEra stops_2018_nano_v0p10  --skipGenLepMatching --sample DYJetsToLL_M4to50_HT100to200 # SPLIT20
#python nanoPostProcessing.py  --forceProxy --skim dilep --year 2018 --processingEra stops_2018_nano_v0p10  --skipGenLepMatching --sample DYJetsToLL_M4to50_HT200to400 # SPLIT20
#python nanoPostProcessing.py  --forceProxy --skim dilep --year 2018 --processingEra stops_2018_nano_v0p10  --skipGenLepMatching --sample DYJetsToLL_M4to50_HT400to600 # SPLIT10
#python nanoPostProcessing.py  --forceProxy --skim dilep --year 2018 --processingEra stops_2018_nano_v0p10  --skipGenLepMatching --sample DYJetsToLL_M4to50_HT600toInf # SPLIT10
#
#
## top
...
#
## di/multi boson
python nanoPostProcessing.py  --forceProxy --skim dilep --year 2018 --processingEra stops_2018_nano_v0p10  --skipGenLepMatching --sample VVTo2L2Nu # SPLIT20
