...
#submitCondor.py $@ --dpm              --maxRetries 10 --resubmitFailedJobs --discSpace 5000 --execFile submit_on_lxplus.sh --output /afs/cern.ch/work/s/schoef/public/condor_logs/mc18/   --queue testmatch nanoPostProcessing_Spring18.sh

submitCondor.py $@ --dpm --hephyToken --maxRetries 10 --resubmitFailedJobs --discSpace 5000 --execFile submit_on_lxplus.sh --output /afs/cern.ch/work/s/schoef/public/condor_logs/data16/ --queue testmatch nanoPostProcessing_Run2016.sh
