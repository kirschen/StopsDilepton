...
def getGenPartsAll(c):
    return [getObjDict(c, 'genPartAll_', ['eta','pt','phi','charge', 'status', 'pdgId', 'motherId', 'grandmotherId','daughterIndex1','daughterIndex2','nMothers','motherIndex1','motherIndex2'], i) for i in range(int(getVarValue(c, 'ngenPartAll')))]
