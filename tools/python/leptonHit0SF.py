...
class leptonHit0SF:
    def __init__(self, year):
        ...
        if   year == 2016:
            keys_mu  = [ ]
            keys_ele = [("2016_ElectronScaleFactors_Run2016.root", "Run2016_ConvIHit0"),
                         ]
        elif year == 2017:
            keys_mu  = []
            keys_ele = [("2017_ElectronScaleFactors_Run2017.root", "Run2017_ConvIHit0"),
                        ]
        elif year == 2018:
            keys_mu  = [] 
            keys_ele = [("2018_ElectronScaleFactors_Run2018.root", "Run2018_ConvIHit0"),
                        ]
...
if __name__ == "__main__":
    sf_2016 = leptonHit0SF( year = 2016 )
    sf_2017 = leptonHit0SF( year = 2017 )
    sf_2018 = leptonHit0SF( year = 2018 )
