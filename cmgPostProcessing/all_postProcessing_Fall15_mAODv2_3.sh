#!/bin/sh
python cmgPostProcessing.py --skim=$1 $2  --samples TTJets_LO_HT600to800 TTJets_LO_HT600to800_ext
python cmgPostProcessing.py --skim=$1 $2  --samples TTJets_LO_HT800to1200
python cmgPostProcessing.py --skim=$1 $2  --samples TTJets_LO_HT1200to2500 TTJets_LO_HT1200to2500_ext
...
python cmgPostProcessing.py --skim=$1 $2  --samples TTHnobb_mWCutfix_ch0 TTHnobb_mWCutfix_ch1
